...
exports.testGenerateInbox14 = function (test) {
    brute(function () {
        var io = generator.generate(14);
...
exports.testGenerateOutbox14 = function (test) {
    var io = generator.generate(14, [ 4, 9, -8, -4, 9, 9, -6, -3 ]);

    test.deepEqual(io.outbox, [ 9, -4, 9, -3 ]);
    test.done();
};
